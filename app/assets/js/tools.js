...
import { delay, defaultTools } from "./lib/lib.js";
import {
  activateToolStorage,
  deactivateToolStorage,
} from "./lib/tool_storage_guard.js";
 ...
 */
export async function setupToolsMenu(toolName = null, allToolsData = null) {
  ...
  const mnTitle = document.getElementById("mn-title");
