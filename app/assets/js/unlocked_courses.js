import { getCompletedCourseList } from "./dataFetching.js";
 ...
 */
export async function loadUnlockedCourses(reload = false) {
 ...
 */
export async function getUnlockedCourseList(program, completedCourseList, craditCompleted) {
